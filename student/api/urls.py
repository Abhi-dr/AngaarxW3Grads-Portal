...
from student.api.views.jovac_api import JOVACListView, JOVACCourseDetailView, JOVACCourseSheetsView, JOVACSheetAssignmentsView, JOVACTutorialDetailView
...
urlpatterns = [
    ...
    path('jovac/tutorial/<int:id>/', JOVACTutorialDetailView.as_view(), name='api_jovac_tutorial_detail'),
